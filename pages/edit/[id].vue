<script setup>
    ...
    const handleSubmit = async() => {
        try {
            const response = await API.put(`/crud/${id}`, form.value);
...
<template>
    ...
    <section class="font-poppins py-20">
        <div class="bg-white w-[70%] min-h-[60vh] rounded-md mx-auto shadow-[6px] p-12">
            <div class="">
                <h1 class="font-[600] text-[32px]">Edit <span class="text-green-800">User</span></h1>
            ...
            <div class="pt-12 flex justify-start items-start gap-20">
                ...
                <div class="flex flex-col gap-6">
                    ...
                    <button @click="handleSubmit" class="bg-green-800 text-white text-[14px] font-[500] py-3 rounded-md cursor-pointer hover:bg-transparent hover:border-green-800 border-3 duration-150 hover:text-green-800">Edit User</button>
                </div>
            </div>
        </div>      
    </section>
